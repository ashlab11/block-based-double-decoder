...
#
# Usage:
#   bash scripts/8_run_comparison.sh
#   bash scripts/8_run_comparison.sh --skip-setup    # skip setup if already done
#   bash scripts/8_run_comparison.sh --skip-data      # skip data download
#   bash scripts/8_run_comparison.sh --eval-only      # skip training, just eval+plot
# ═══════════════════════════════════════════════════════════════════════════
