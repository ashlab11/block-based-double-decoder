...
def main():
    ...
    parser.add_argument("--batch-size", type=int, default=64,
                        help="Micro-batch size in sequences (default: 64)")
    parser.add_argument("--grad-accum", type=int, default=8,
                        help="Gradient accumulation steps (default: 8, eff_batch=512)")
    ...
    for batch_idx, raw_batch in enumerate(train_loader):
        ...
        # create_pretrain_masks, so we can't safely overlap forward passes
        # on CUDA streams. Sequential is correct and fast for tiny models.
        for t in trainers:
