...
#
# Usage:
#   bash scripts/run_all.sh                    # full run from scratch
#   bash scripts/run_all.sh --skip-setup       # skip environment setup
#   bash scripts/run_all.sh --skip-data        # skip data download
#   bash scripts/run_all.sh --phase2-only      # skip pretrain, run SFT+eval only
#   bash scripts/run_all.sh --eval-only        # skip all training, just eval+plot
#
